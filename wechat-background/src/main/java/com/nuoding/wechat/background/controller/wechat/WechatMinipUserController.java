...
public class WechatMinipUserController {
    ...
    public MapResponse queryByPage(@RequestBody WechatMinipUserEntity wechatMinipUserEntity, @RequestBody PageQueryBaseDTO dto) {
        ...
        // wechatMinipUserEntity.setTenantId(SessionKey.getTenantId);
    ...
    public MapResponse fuzzyQuery(@RequestBody WechatMinipUserEntity wechatMinipUserEntity, @RequestBody PageQueryBaseDTO dto) {
        MapResponse mapResponse = new MapResponse();
        logger.info("fuzzyQuery begin.wechatMinipUserEntity:{},dto:{}", JsonUtil.obj2Json(wechatMinipUserEntity),JsonUtil.obj2Json(dto));
        PageHelper.startPage(dto.getPageNum(), dto.getPageSize());
        // wechatMinipUserEntity.setTenantId(SessionKey.getTenantId);
        List<WechatMinipUserEntity> list = this.wechatMinipUserService.fuzzyQuery(wechatMinipUserEntity);
        PageInfo pageInfo = new PageInfo(list);
        Map map = PageInfoUtil.parseReturnMap(pageInfo);
        mapResponse.setData(map);
        logger.info("queryByPage end.mapResponse:{}", JsonUtil.obj2Json(mapResponse));
     ...
     */
    @PostMapping("/add")
    public MapResponse add(@RequestBody WechatMinipUserEntity wechatMinipUserEntity) {
     ...
     */
    @PostMapping("/edit")
    public MapResponse edit(@RequestBody WechatMinipUserEntity wechatMinipUserEntity) {
        MapResponse mapResponse = new MapResponse();
     ...
     */
    @PostMapping("/delete")
    public MapResponse deleteById(@RequestBody WechatMinipUserEntity wechatMinipUserEntity) {
        ...
        this.wechatMinipUserService.deleteById(id);
