...
public class UserLocationRecordController {
     ...
     */
    @PostMapping("/add")
    public MapResponse add(UserLocationRecordEntity userLocationRecordEntity) {
     ...
     */
    @PostMapping("/edit")
    public MapResponse edit(UserLocationRecordEntity userLocationRecordEntity) {
        MapResponse mapResponse = new MapResponse();
     ...
     */
    @PostMapping("/delete")
    public MapResponse deleteById(UserLocationRecordEntity userLocationRecordEntity) {
        ...
        boolean b = this.userLocationRecordService.deleteById(id);
        if (b) {
