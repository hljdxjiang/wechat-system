...
public class CrmProdGroupController {
    ...
    public MapResponse queryByPage(@RequestBody CrmProdGroupEntity crmProdGroupEntity, @RequestBody PageQueryBaseDTO dto) {
        ...
        List<CrmProdGroupEntity> list = this.crmProdGroupService.queryByPage(crmProdGroupEntity);
     ...
     */
    @PostMapping("/add")
    public MapResponse add(CrmProdGroupEntity crmProdGroupEntity) {
        MapResponse mapResponse = new MapResponse();
     ...
     */
    @PostMapping("/edit")
    public MapResponse edit(CrmProdGroupEntity crmProdGroupEntity) {
        MapResponse mapResponse = new MapResponse();
     ...
     */
    @PostMapping("/delete")
    public MapResponse deleteById(CrmProdGroupEntity crmProdGroupEntity) {
