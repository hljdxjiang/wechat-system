...
public class WechatMenusItemController {
     ...
     */
    @Resource
    private WechatMenusItemService wechatMenusItemService;
    ...
    public MapResponse queryByPage(@RequestBody WechatMenusItemEntity wechatMenusItemEntity, @RequestBody PageQueryBaseDTO dto) {
        ...
        List<WechatMenusItemEntity> list = this.wechatMenusItemService.queryByPage(wechatMenusItemEntity);
     ...
     * 新增数据
     *
     * @param wechatMenusItemEntity 实体
     * @return 新增结果
     */
    @PostMapping("/add")
    ...
    public MapResponse deleteById(WechatMenusItemEntity wechatMenusItemEntity) {
        ...
        boolean b = this.wechatMenusItemService.deleteById(id);
        if (b) {
