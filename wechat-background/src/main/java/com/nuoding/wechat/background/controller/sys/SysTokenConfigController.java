...
public class SysTokenConfigController {
    ...
    public MapResponse queryByPage(@RequestBody SysTokenConfigEntity sysTokenConfigEntity, @RequestBody PageQueryBaseDTO dto) {
        ...
        // sysTokenConfigEntity.setTenantId(SessionKey.getTenantId);
    ...
    public MapResponse fuzzyQuery(@RequestBody SysTokenConfigEntity sysTokenConfigEntity, @RequestBody PageQueryBaseDTO dto) {
        MapResponse mapResponse = new MapResponse();
        logger.info("fuzzyQuery begin.sysTokenConfigEntity:{},dto:{}", JsonUtil.obj2Json(sysTokenConfigEntity),JsonUtil.obj2Json(dto));
        PageHelper.startPage(dto.getPageNum(), dto.getPageSize());
        // sysTokenConfigEntity.setTenantId(SessionKey.getTenantId);
        List<SysTokenConfigEntity> list = this.sysTokenConfigService.fuzzyQuery(sysTokenConfigEntity);
        PageInfo pageInfo = new PageInfo(list);
        Map map = PageInfoUtil.parseReturnMap(pageInfo);
        mapResponse.setData(map);
        logger.info("queryByPage end.mapResponse:{}", JsonUtil.obj2Json(mapResponse));
     ...
     */
    @PostMapping("/add")
    public MapResponse add(@RequestBody SysTokenConfigEntity sysTokenConfigEntity) {
     ...
     */
    @PostMapping("/edit")
    public MapResponse edit(@RequestBody SysTokenConfigEntity sysTokenConfigEntity) {
        MapResponse mapResponse = new MapResponse();
     ...
     */
    @PostMapping("/delete")
    public MapResponse deleteById(@RequestBody SysTokenConfigEntity sysTokenConfigEntity) {
        ...
        this.sysTokenConfigService.deleteById(id);
