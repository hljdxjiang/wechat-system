...
public class CrmProdTypeController {
    ...
    public MapResponse queryByPage(@RequestBody CrmProdTypeEntity crmProdTypeEntity, @RequestBody PageQueryBaseDTO dto) {
        ...
        // crmProdTypeEntity.setTenantId(SessionKey.getTenantId);
    ...
    public MapResponse fuzzyQuery(@RequestBody CrmProdTypeEntity crmProdTypeEntity, @RequestBody PageQueryBaseDTO dto) {
        MapResponse mapResponse = new MapResponse();
        logger.info("fuzzyQuery begin.crmProdTypeEntity:{},dto:{}", JsonUtil.obj2Json(crmProdTypeEntity), JsonUtil.obj2Json(dto));
        PageHelper.startPage(dto.getPageNum(), dto.getPageSize());
        // crmProdTypeEntity.setTenantId(SessionKey.getTenantId);
        List<CrmProdTypeEntity> list = this.crmProdTypeService.fuzzyQuery(crmProdTypeEntity);
        PageInfo pageInfo = new PageInfo(list);
        Map map = PageInfoUtil.parseReturnMap(pageInfo);
        mapResponse.setData(map);
        logger.info("queryByPage end.mapResponse:{}", JsonUtil.obj2Json(mapResponse));
     ...
     */
    @PostMapping("/add")
    public MapResponse add(@RequestBody CrmProdTypeEntity crmProdTypeEntity) {
     ...
     */
    @PostMapping("/edit")
    public MapResponse edit(@RequestBody CrmProdTypeEntity crmProdTypeEntity) {
        MapResponse mapResponse = new MapResponse();
     ...
     */
    @PostMapping("/delete")
    public MapResponse deleteById(@RequestBody CrmProdTypeEntity crmProdTypeEntity) {
        ...
        this.crmProdTypeService.deleteById(id);
