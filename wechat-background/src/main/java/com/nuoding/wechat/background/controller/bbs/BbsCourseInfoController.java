...
@RestController
@RequestMapping("/background/bbsCourseInfo")
public class BbsCourseInfoController {
     ...
     */
    @Resource
    private BbsCourseInfoService bbsCourseInfoService;
