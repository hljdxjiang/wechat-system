...
public class WechatMenusDetailController {
    ...
    public MapResponse queryByPage(@RequestBody WechatMenusDetailEntity wechatMenusDetailEntity, @RequestBody PageQueryBaseDTO dto) {
        ...
        logger.info("queryByPage begin.wechatMenusDetailEntity:{},dto:{}", JsonUtil.obj2Json(wechatMenusDetailEntity),JsonUtil.obj2Json(dto));
        PageHelper.startPage(dto.getPageNum(), dto.getPageSize());
        // wechatMenusDetailEntity.setTenantId(SessionKey.getTenantId);
    ...
    public MapResponse fuzzyQuery(@RequestBody WechatMenusDetailEntity wechatMenusDetailEntity, @RequestBody PageQueryBaseDTO dto) {
        MapResponse mapResponse = new MapResponse();
        logger.info("fuzzyQuery begin.wechatMenusDetailEntity:{},dto:{}", JsonUtil.obj2Json(wechatMenusDetailEntity),JsonUtil.obj2Json(dto));
        PageHelper.startPage(dto.getPageNum(), dto.getPageSize());
        // wechatMenusDetailEntity.setTenantId(SessionKey.getTenantId);
        List<WechatMenusDetailEntity> list = this.wechatMenusDetailService.fuzzyQuery(wechatMenusDetailEntity);
        PageInfo pageInfo = new PageInfo(list);
        Map map = PageInfoUtil.parseReturnMap(pageInfo);
        mapResponse.setData(map);
        logger.info("queryByPage end.mapResponse:{}", JsonUtil.obj2Json(mapResponse));
     ...
     */
    @PostMapping("/add")
    public MapResponse add(@RequestBody WechatMenusDetailEntity wechatMenusDetailEntity) {
        logger.info("add begin.wechatMenusDetailEntity:{}",JsonUtil.obj2Json(wechatMenusDetailEntity));
        MapResponse mapResponse = new MapResponse();
        // wechatMenusDetailEntity.setTenantId(SessionKey.getTenantId);
     ...
     */
    @PostMapping("/edit")
    public MapResponse edit(@RequestBody WechatMenusDetailEntity wechatMenusDetailEntity) {
        MapResponse mapResponse = new MapResponse();
        logger.info("edit begin.wechatMenusDetailEntity:{}",JsonUtil.obj2Json(wechatMenusDetailEntity));
     ...
     */
    @PostMapping("/delete")
    public MapResponse deleteById(@RequestBody WechatMenusDetailEntity wechatMenusDetailEntity) {

        MapResponse mapResponse = new MapResponse();
        logger.info("deleteById begin.wechatMenusDetailEntity:{}",JsonUtil.obj2Json(wechatMenusDetailEntity));
        Integer id = wechatMenusDetailEntity.getId();
        if (id == null || id == 0) {
            mapResponse.setResponse(RespStatusEnum.ARGS_ERROR);
            return mapResponse;
        }
        this.wechatMenusDetailService.deleteById(id);
