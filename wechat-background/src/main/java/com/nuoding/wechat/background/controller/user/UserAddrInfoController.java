...
public class UserAddrInfoController {
    ...
    public MapResponse queryByPage(@RequestBody UserAddrInfoEntity userAddrInfoEntity, @RequestBody PageQueryBaseDTO dto) {
        ...
        // userAddrInfoEntity.setTenantId(SessionKey.getTenantId);
    ...
    public MapResponse fuzzyQuery(@RequestBody UserAddrInfoEntity userAddrInfoEntity, @RequestBody PageQueryBaseDTO dto) {
        MapResponse mapResponse = new MapResponse();
        logger.info("fuzzyQuery begin.userAddrInfoEntity:{},dto:{}", JsonUtil.obj2Json(userAddrInfoEntity), JsonUtil.obj2Json(dto));
        PageHelper.startPage(dto.getPageNum(), dto.getPageSize());
        // userAddrInfoEntity.setTenantId(SessionKey.getTenantId);
        List<UserAddrInfoEntity> list = this.userAddrInfoService.fuzzyQuery(userAddrInfoEntity);
        PageInfo pageInfo = new PageInfo(list);
        Map map = PageInfoUtil.parseReturnMap(pageInfo);
        mapResponse.setData(map);
        logger.info("queryByPage end.mapResponse:{}", JsonUtil.obj2Json(mapResponse));
     ...
     */
    @PostMapping("/add")
    public MapResponse add(@RequestBody UserAddrInfoEntity userAddrInfoEntity) {
     ...
     */
    @PostMapping("/edit")
    public MapResponse edit(@RequestBody UserAddrInfoEntity userAddrInfoEntity) {
        MapResponse mapResponse = new MapResponse();
     ...
     */
    @PostMapping("/delete")
    public MapResponse deleteById(@RequestBody UserAddrInfoEntity userAddrInfoEntity) {
        ...
        this.userAddrInfoService.deleteById(id);
