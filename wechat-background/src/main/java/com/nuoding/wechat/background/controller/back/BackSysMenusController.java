...
public class BackSysMenusController {
    ...
    public MapResponse queryByPage(@RequestBody BackSysMenusEntity backSysMenusEntity, @RequestBody PageQueryBaseDTO dto) {
        ...
        List<BackSysMenusEntity> list = this.backSysMenusService.queryByPage(backSysMenusEntity);
     ...
     */
    @PostMapping("/add")
    public MapResponse add(BackSysMenusEntity backSysMenusEntity) {
        MapResponse mapResponse = new MapResponse();
     ...
     */
    @PostMapping("/edit")
    public MapResponse edit(BackSysMenusEntity backSysMenusEntity) {
        MapResponse mapResponse = new MapResponse();
     ...
     */
    @PostMapping("/delete")
    public MapResponse deleteById(BackSysMenusEntity backSysMenusEntity) {
