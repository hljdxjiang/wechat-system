...
public class SysParamConfigController {
     ...
     * 新增数据
     *
     * @param sysParamConfigEntity 实体
     * @return 新增结果
     */
    @PostMapping("/add")
    public MapResponse add(SysParamConfigEntity sysParamConfigEntity) {
        MapResponse mapResponse = new MapResponse();
     ...
     */
    @PostMapping("/edit")
    public MapResponse edit(SysParamConfigEntity sysParamConfigEntity) {
        MapResponse mapResponse = new MapResponse();
     ...
     */
    @PostMapping("/delete")
    public MapResponse deleteById(SysParamConfigEntity sysParamConfigEntity) {
