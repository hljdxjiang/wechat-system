...
public class CrmReferrerInfoController {
    ...
    public MapResponse queryByPage(@RequestBody CrmReferrerInfoEntity crmReferrerInfoEntity, @RequestBody PageQueryBaseDTO dto) {
        ...
        // crmReferrerInfoEntity.setTenantId(SessionKey.getTenantId);
    ...
    public MapResponse fuzzyQuery(@RequestBody CrmReferrerInfoEntity crmReferrerInfoEntity, @RequestBody PageQueryBaseDTO dto) {
        MapResponse mapResponse = new MapResponse();
        logger.info("fuzzyQuery begin.crmReferrerInfoEntity:{},dto:{}", JsonUtil.obj2Json(crmReferrerInfoEntity), JsonUtil.obj2Json(dto));
        PageHelper.startPage(dto.getPageNum(), dto.getPageSize());
        // crmReferrerInfoEntity.setTenantId(SessionKey.getTenantId);
        List<CrmReferrerInfoEntity> list = this.crmReferrerInfoService.fuzzyQuery(crmReferrerInfoEntity);
        PageInfo pageInfo = new PageInfo(list);
        Map map = PageInfoUtil.parseReturnMap(pageInfo);
        mapResponse.setData(map);
        logger.info("queryByPage end.mapResponse:{}", JsonUtil.obj2Json(mapResponse));
     ...
     */
    @PostMapping("/add")
    public MapResponse add(@RequestBody CrmReferrerInfoEntity crmReferrerInfoEntity) {
     ...
     */
    @PostMapping("/edit")
    public MapResponse edit(@RequestBody CrmReferrerInfoEntity crmReferrerInfoEntity) {
        MapResponse mapResponse = new MapResponse();
     ...
     */
    @PostMapping("/delete")
    public MapResponse deleteById(@RequestBody CrmReferrerInfoEntity crmReferrerInfoEntity) {
        ...
        this.crmReferrerInfoService.deleteById(id);
