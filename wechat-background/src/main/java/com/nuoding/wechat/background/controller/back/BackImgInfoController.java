...
public class BackImgInfoController {
    ...
    public MapResponse queryByPage(@RequestBody BackImgInfoEntity backImgInfoEntity, @RequestBody PageQueryBaseDTO dto) {
        ...
        logger.info("queryByPage begin.backImgInfoEntity:{},dto:{}", JsonUtil.obj2Json(backImgInfoEntity), JsonUtil.obj2Json(dto));
        PageHelper.startPage(dto.getPageNum(), dto.getPageSize());
        // backImgInfoEntity.setTenantId(SessionKey.getTenantId);
    ...
    public MapResponse fuzzyQuery(@RequestBody BackImgInfoEntity backImgInfoEntity, @RequestBody PageQueryBaseDTO dto) {
        MapResponse mapResponse = new MapResponse();
        logger.info("fuzzyQuery begin.backImgInfoEntity:{},dto:{}", JsonUtil.obj2Json(backImgInfoEntity), JsonUtil.obj2Json(dto));
        PageHelper.startPage(dto.getPageNum(), dto.getPageSize());
        // backImgInfoEntity.setTenantId(SessionKey.getTenantId);
        List<BackImgInfoEntity> list = this.backImgInfoService.fuzzyQuery(backImgInfoEntity);
        PageInfo pageInfo = new PageInfo(list);
        Map map = PageInfoUtil.parseReturnMap(pageInfo);
        mapResponse.setData(map);
        logger.info("queryByPage end.mapResponse:{}", JsonUtil.obj2Json(mapResponse));
     ...
     */
    @PostMapping("/add")
    public MapResponse add(@RequestBody BackImgInfoEntity backImgInfoEntity) {
        logger.info("add begin.backImgInfoEntity:{}", JsonUtil.obj2Json(backImgInfoEntity));
        MapResponse mapResponse = new MapResponse();
        // backImgInfoEntity.setTenantId(SessionKey.getTenantId);
     ...
     */
    @PostMapping("/edit")
    public MapResponse edit(@RequestBody BackImgInfoEntity backImgInfoEntity) {
        MapResponse mapResponse = new MapResponse();
        logger.info("edit begin.backImgInfoEntity:{}", JsonUtil.obj2Json(backImgInfoEntity));
     ...
     */
    @PostMapping("/delete")
    public MapResponse deleteById(@RequestBody BackImgInfoEntity backImgInfoEntity) {

        MapResponse mapResponse = new MapResponse();
        logger.info("deleteById begin.backImgInfoEntity:{}", JsonUtil.obj2Json(backImgInfoEntity));
        Integer id = backImgInfoEntity.getId();
        if (id == null || id == 0) {
            mapResponse.setResponse(RespStatusEnum.ARGS_ERROR);
            return mapResponse;
        }
        this.backImgInfoService.deleteById(id);
