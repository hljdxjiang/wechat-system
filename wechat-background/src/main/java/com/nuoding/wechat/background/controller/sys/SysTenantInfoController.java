...
public class SysTenantInfoController {
    ...
    public MapResponse queryByPage(@RequestBody SysTenantInfoEntity sysTenantInfoEntity, @RequestBody PageQueryBaseDTO dto) {
        ...
        // sysTenantInfoEntity.setTenantId(SessionKey.getTenantId);
    ...
    public MapResponse fuzzyQuery(@RequestBody SysTenantInfoEntity sysTenantInfoEntity, @RequestBody PageQueryBaseDTO dto) {
        MapResponse mapResponse = new MapResponse();
        logger.info("fuzzyQuery begin.sysTenantInfoEntity:{},dto:{}", JsonUtil.obj2Json(sysTenantInfoEntity), JsonUtil.obj2Json(dto));
        PageHelper.startPage(dto.getPageNum(), dto.getPageSize());
        // sysTenantInfoEntity.setTenantId(SessionKey.getTenantId);
        List<SysTenantInfoEntity> list = this.sysTenantInfoService.fuzzyQuery(sysTenantInfoEntity);
        PageInfo pageInfo = new PageInfo(list);
        Map map = PageInfoUtil.parseReturnMap(pageInfo);
        mapResponse.setData(map);
        logger.info("queryByPage end.mapResponse:{}", JsonUtil.obj2Json(mapResponse));
     ...
     */
    @PostMapping("/add")
    public MapResponse add(@RequestBody SysTenantInfoEntity sysTenantInfoEntity) {
     ...
     */
    @PostMapping("/edit")
    public MapResponse edit(@RequestBody SysTenantInfoEntity sysTenantInfoEntity) {
        MapResponse mapResponse = new MapResponse();
     ...
     */
    @PostMapping("/delete")
    public MapResponse deleteById(@RequestBody SysTenantInfoEntity sysTenantInfoEntity) {
        ...
        this.sysTenantInfoService.deleteById(id);
