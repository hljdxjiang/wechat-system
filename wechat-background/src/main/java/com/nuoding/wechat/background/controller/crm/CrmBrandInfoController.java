...
public class CrmBrandInfoController {
    ...
    public MapResponse queryByPage(@RequestBody CrmBrandInfoEntity crmBrandInfoEntity, @RequestBody PageQueryBaseDTO dto) {
        ...
        logger.info("queryByPage begin.crmBrandInfoEntity:{},dto:{}", JsonUtil.obj2Json(crmBrandInfoEntity),JsonUtil.obj2Json(dto));
        PageHelper.startPage(dto.getPageNum(), dto.getPageSize());
        // crmBrandInfoEntity.setTenantId(SessionKey.getTenantId);
    ...
    public MapResponse fuzzyQuery(@RequestBody CrmBrandInfoEntity crmBrandInfoEntity, @RequestBody PageQueryBaseDTO dto) {
        MapResponse mapResponse = new MapResponse();
        logger.info("fuzzyQuery begin.crmBrandInfoEntity:{},dto:{}", JsonUtil.obj2Json(crmBrandInfoEntity),JsonUtil.obj2Json(dto));
        PageHelper.startPage(dto.getPageNum(), dto.getPageSize());
        // crmBrandInfoEntity.setTenantId(SessionKey.getTenantId);
        List<CrmBrandInfoEntity> list = this.crmBrandInfoService.fuzzyQuery(crmBrandInfoEntity);
        PageInfo pageInfo = new PageInfo(list);
        Map map = PageInfoUtil.parseReturnMap(pageInfo);
        mapResponse.setData(map);
        logger.info("queryByPage end.mapResponse:{}", JsonUtil.obj2Json(mapResponse));
     ...
     */
    @PostMapping("/add")
    public MapResponse add(@RequestBody CrmBrandInfoEntity crmBrandInfoEntity) {
        logger.info("add begin.crmBrandInfoEntity:{}",JsonUtil.obj2Json(crmBrandInfoEntity));
        MapResponse mapResponse = new MapResponse();
        // crmBrandInfoEntity.setTenantId(SessionKey.getTenantId);
     ...
     */
    @PostMapping("/edit")
    public MapResponse edit(@RequestBody CrmBrandInfoEntity crmBrandInfoEntity) {
        MapResponse mapResponse = new MapResponse();
        logger.info("edit begin.crmBrandInfoEntity:{}",JsonUtil.obj2Json(crmBrandInfoEntity));
     ...
     */
    @PostMapping("/delete")
    public MapResponse deleteById(@RequestBody CrmBrandInfoEntity crmBrandInfoEntity) {

        MapResponse mapResponse = new MapResponse();
        logger.info("deleteById begin.crmBrandInfoEntity:{}",JsonUtil.obj2Json(crmBrandInfoEntity));
        Integer id = crmBrandInfoEntity.getId();
        if (id == null || id == 0) {
            mapResponse.setResponse(RespStatusEnum.ARGS_ERROR);
            return mapResponse;
        }
        this.crmBrandInfoService.deleteById(id);
