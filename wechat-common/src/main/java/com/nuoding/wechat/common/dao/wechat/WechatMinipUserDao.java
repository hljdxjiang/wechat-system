...
public interface WechatMinipUserDao {
     ...
     * @return 总行数
     */
    long count(WechatMinipUserEntity wechatMinipUserEntity);
     ...
     * @return 影响行数
     */
    int insert(WechatMinipUserEntity wechatMinipUserEntity);

    /**
     * 批量新增数据（MyBatis原生foreach方法）
     *
     * @param entities List<WechatMinipUserEntity> 实例对象列表
     * @return 影响行数
     */
    int insertBatch(@Param("entities") List<WechatMinipUserEntity> entities);
     ...
     */
    int insertOrUpdateBatch(@Param("entities") List<WechatMinipUserEntity> entities);
     ...
     * @return 影响行数
     */
    int update(WechatMinipUserEntity wechatMinipUserEntity);
