...
public interface MallActivityUserDao {
     ...
     * @return 对象列表
     */
    MallActivityUserEntity selectOne(MallActivityUserEntity mallActivityUserEntity);
     ...
     * @return 对象列表
     */
    List<MallActivityUserEntity> fuzzyQuery(MallActivityUserEntity mallActivityUserEntity);
