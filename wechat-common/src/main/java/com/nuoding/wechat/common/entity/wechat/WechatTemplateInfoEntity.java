...
public class WechatTemplateInfoEntity implements Serializable {
    ...
    private static final long serialVersionUID = 1L;
            ...
            /**
             * 模板配置：是否起用|是否推送非实名|是否保存推送记录 0否1是
             */
            ...
            /**
             * 消息类型：TEMPLATE：模板消息 SUBSCRIBLE:订阅消息
             */
        ...
        /**
         * 获取：模板配置：是否起用|是否推送非实名|是否保存推送记录 0否1是
         */
        ...
        /**
         * 设置：模板配置：是否起用|是否推送非实名|是否保存推送记录 0否1是
         */
        ...
        /**
         * 获取：消息类型：TEMPLATE：模板消息 SUBSCRIBLE:订阅消息
         */
        ...
        /**
         * 设置：消息类型：TEMPLATE：模板消息 SUBSCRIBLE:订阅消息
         */
