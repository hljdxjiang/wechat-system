...
public interface CrmProdDetailDao {
     ...
     * 查询指定行数据
     *
     * @param crmProdDetailEntity 查询条件
     * @return 对象列表
     */
     ...
     * @return 总行数
     */
    long count(CrmProdDetailEntity crmProdDetailEntity);
     ...
     * @return 影响行数
     */
    int insert(CrmProdDetailEntity crmProdDetailEntity);

    /**
     * 批量新增数据（MyBatis原生foreach方法）
     *
     * @param entities List<CrmProdDetailEntity> 实例对象列表
     * @return 影响行数
     */
    int insertBatch(@Param("entities") List<CrmProdDetailEntity> entities);
     ...
     */
    int insertOrUpdateBatch(@Param("entities") List<CrmProdDetailEntity> entities);
     ...
     * @return 影响行数
     */
    int update(CrmProdDetailEntity crmProdDetailEntity);
