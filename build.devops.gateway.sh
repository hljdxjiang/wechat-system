...
#编译的代码包保存路径常量
output_const="output"
app_version="wecaht-gateway-1.0.0-SNAPSHOT"
app_version_tar_gz="wecaht-gateway-1.0.0-SNAPSHOT.tar.gz"

app_jar_version="wecaht-gateway-1.0.0-SNAPSHOT.jar"
app_jar="wecaht-gateway.jar"

app_const="wecaht-gateway"
app_tar_gz="wecaht-gateway.tar.gz"

app_conf_build="conf"
app_conf_tar_gz="wecaht-gateway-conf.tar.gz"
...
build_main_module_name="wechat/deposit_product/wecaht-gateway"
